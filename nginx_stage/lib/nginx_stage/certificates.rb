...
module NginxStage
  ...
  class UserCertificate
    ...
    def generate
      ...
      # Write the key to disk TODO: encrypt with secret?
    ...
    # @return [Boolean] whether or not the cert will expire in the next 30 days
    def expires_soon?
      cert = OpenSSL::X509::Certificate.new File.read @cert_path
      cert.not_after < Time.now + 60 * 60 * 24 * 30
    end

    # @return [Boolean] whether or not the cert exists and is valid for one month
    def valid?
